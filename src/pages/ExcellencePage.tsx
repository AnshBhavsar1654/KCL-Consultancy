          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-8">
              <div className="flex items-center mb-8">
                ...
                <h2 className="text-3xl md:text-4xl font-semibold text-kcl-blue">Healthcare 2.0</h2>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
                <div className="bg-gray-50 p-5 rounded-lg">
                  <h4 className="font-semibold text-kcl-blue mb-2">Digital Health & Telemedicine</h4>
                  <p className="text-gray-600">Enhancing access to healthcare through digital transformation and remote care solutions.</p>
                </div>
                
                <div className="bg-gray-50 p-5 rounded-lg">
                  <h4 className="font-semibold text-kcl-blue mb-2">Health Policy & Systems Strengthening</h4>
                  <p className="text-gray-600">Crafting policies that improve healthcare efficiency, equity, and outcomes for all populations.</p>
                </div>
                
                <div className="bg-gray-50 p-5 rounded-lg">
                  <h4 className="font-semibold text-kcl-blue mb-2">Data-Driven Healthcare</h4>
                  <p className="text-gray-600">Leveraging analytics for precision medicine, better health interventions, and improved resource allocation.</p>
                </div>
                
                <div className="bg-gray-50 p-5 rounded-lg">
                  <h4 className="font-semibold text-kcl-blue mb-2">Knowledge Hub</h4>
                  <p className="text-gray-600">Serving as a center for best practices, innovation, and industry insights in the healthcare sector.</p>
                </div>
              </div>
            ...
            <div className="lg:col-span-4">
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <h4 className="font-medium text-kcl-blue mb-2">National Telemedicine Network</h4>
                ...
                <h4 className="font-medium text-kcl-blue mb-2">Healthcare Policy Reform</h4>
                <p className="text-gray-600 mb-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-4 order-2 lg:order-1">
              <div className="space-y-6">
                <div className="bg-white p-6 rounded-lg shadow-md">
                  <h4 className="font-semibold text-kcl-blue mb-2">Smart Cities Development</h4>
                ...
                <div className="bg-white p-6 rounded-lg shadow-md">
                  <h4 className="font-semibold text-kcl-blue mb-2">Sustainable Urban Planning</h4>
                  <p className="text-gray-600">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md">
                  <h4 className="font-semibold text-kcl-blue mb-2">Infrastructure & Mobility</h4>
                  <p className="text-gray-600">
            ...
            <div className="lg:col-span-8 order-1 lg:order-2">
              <div className="flex items-center mb-8">
                ...
                <h2 className="text-3xl md:text-4xl font-semibold text-kcl-blue">Urban Rejuvenation</h2>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md mb-8">
                <h3 className="text-xl font-semibold mb-4">Featured Project: Riverside District Transformation</h3>
                <p className="text-gray-600 mb-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white p-5 rounded-lg shadow-md">
                  <h4 className="font-semibold text-kcl-blue mb-2">Environment and Social Risks</h4>
                  <p className="text-gray-600">Mitigating risks and ensuring sustainable urban development through comprehensive impact assessments.</p>
                </div>
                
                <div className="bg-white p-5 rounded-lg shadow-md">
                  <h4 className="font-semibold text-kcl-blue mb-2">Design Standards & Guidelines</h4>
                  <p className="text-gray-600">Setting industry benchmarks for urban growth that balance innovation with cultural heritage.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            <div className="lg:col-span-8">
              <div className="flex items-center mb-8">
                ...
                <h2 className="text-3xl md:text-4xl font-semibold text-kcl-blue">AI + Digital Transformation</h2>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="bg-gray-50 p-5 rounded-lg">
                  <h4 className="font-semibold text-kcl-blue mb-2">AI-Driven Decision Making</h4>
                  <p className="text-gray-600">Empowering organizations with predictive analytics, automation, and data-driven insights.</p>
                </div>
                
                <div className="bg-gray-50 p-5 rounded-lg">
                  <h4 className="font-semibold text-kcl-blue mb-2">Digital Transformation Strategies</h4>
                  <p className="text-gray-600">Helping businesses and governments transition into the digital era with comprehensive roadmaps.</p>
                </div>
                
                <div className="bg-gray-50 p-5 rounded-lg">
                  <h4 className="font-semibold text-kcl-blue mb-2">Cybersecurity & Data Ethics</h4>
                  <p className="text-gray-600">Ensuring safe and responsible adoption of digital solutions with robust security frameworks.</p>
                </div>
              </div>
              ...
              <div className="bg-gray-50 p-8 rounded-lg">
                ...
                <div className="space-y-6">
                  <div className="flex">
                    ...
                    <div>
                      <h4 className="font-semibold text-lg">Assess</h4>
                      <p className="text-gray-600">Comprehensive evaluation of current digital maturity, capabilities, and opportunities</p>
                    </div>
                  </div>
                  ...
                  <div className="flex">
                    ...
                    <div>
                      <h4 className="font-semibold text-lg">Envision</h4>
                      <p className="text-gray-600">Co-creating a clear digital vision and strategy aligned with organizational goals</p>
                    </div>
                  </div>
                  ...
                  <div className="flex">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Developing a practical implementation plan with prioritized initiatives</p>
                    </div>
                  </div>
                  ...
                  <div className="flex">
                    ...
                    <div>
                      <h4 className="font-semibold text-lg">Transform</h4>
                      <p className="text-gray-600">Executing the digital initiatives with agile methodology and change management</p>
                    </div>
                  </div>
                  ...
                  <div className="flex">
                    ...
                    <div>
                      <h4 className="font-semibold text-lg">Optimize</h4>
                      <p className="text-gray-600">Continuous improvement based on outcomes and emerging technologies</p>
                    </div>
                  </div>
                </div>
              </div>
